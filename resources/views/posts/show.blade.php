...
<div class="container mx-auto md:flex">
    <div class="md:w-1/2">
        ...
        <div class="p-3 flex items-center gap-4">
            ...
            @if($post->checkLike(auht()->user()))
            <form method="post" action="{{route('posts.likes.detroy',$post)}}">
                @method('DELETE')
                @csrf
                <div class="my-4">
                    <button type="submit">
    ...
    <div class="md:w-1/2 p-5">
        ...
        <div class="shadow bg-white p-5 mb-5">
            ...
            <form action="{{route('comentarios.store',['post'=>$post,'user'=>$user])}}" method="POST">
                @csrf
                <div class="mb-5">
                    <label for="comentario" class="mb-2 block uppercase text-gray-500 font-bold">Comentario

                    </label>
                    <textarea id="comentario" name="comentario" type="text" placeholder="Agrega un comentario" class="border p-3 w-full rounded-lg @error('comentario') border-red-500
